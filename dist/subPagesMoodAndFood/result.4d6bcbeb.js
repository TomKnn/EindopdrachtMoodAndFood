...
parcelHelpers.export(exports, "recipeByPreferenceResults", ()=>recipeByPreferenceResults
);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const getRecipeByPreference = async ()=>{
    return _axiosDefault.default.get('https://api.spoonacular.com/recipes/complexSearch?number=2&apiKey=b4408aa9ab144e47ae2bf8eff93e72f5', {
        headers: {
